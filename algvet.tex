...
\begin{align}
\vct{u}+\vct{v}&=\vct{v}+\vct{u},&\hbox{(Comutatividade da soma)}\label{defelcom}\\
\vct{u}+\left(\vct{v}+\vct{w}\right)&=\left(\vct{v}+\vct{u}\right)+\vct{w},&\hbox{(Associatividade da soma)}\label{defelass}\\
\left(\alpha+\beta\right) \vct{u}&=\alpha\vct{u}+\beta\vct{v},&\hbox{(Distributividade da multiplicação sobre a soma)}\label{defeldist1}\\
\alpha \left(\vct{u}+\vct{v}\right)&= \alpha \vct{u}+\alpha\vct{v},&\hbox{(Distributividade da soma sobre a multiplicação)}\label{defeldist2}\\
\alpha \left(\beta\vct{u}\right)&=\left(\alpha\beta\right)\vct{u},\label{defeldist3}\\
\vct{0}+\vct{v}&=\vct{v}, &\hbox{(Existência de um vetor nulo)}\label{defelnulo}\\
0\vct{v}&=\vct{0},\label{defelnulo2}\\
1\vct{v}&=\vct{v}.&\hbox{(Elemento neutro)}\label{defelneutro}
\end{align}
\end{subequations}
...
\begin{obs} O vetor nulo $\vct{0}$ e escalar nulo $0$ são entidades matemáticas distintas e não devem ser confundidas.
\end{obs} 
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
    \includegraphics[width=0.48\textwidth]{regra_mao}
  \end{center}
  \caption{À esquerda, um sistema levogiro (regra da mão esquerda). À direita, um sistema dextrogiro (regra da mão direita).}
\end{wrapfigure}
...
\begin{align}
\|\alpha \vct{u}\|&=|\alpha|~\!\|\vct{u}\|,&\hbox{(Homogeneidade)}\label{propnormahom}\\
\|\vct{u}+\vct{v}\|&\leq \|\vct{u}\|+\|\vct{v}\|,&\hbox{(Desigualdade triangular)}\label{propnormatri}\\
\|\vct{u}\|&=0 \Longrightarrow \vct{u}=\vct{0},&\hbox{(Separação)}\label{propnormasep}
\end{align}
\end{subequations}
\end{prob}
...
\begin{wrapfigure}{r}{0.3\textwidth}
  \begin{center}
  \vspace{-20pt}
    \includegraphics[width=0.26\textwidth]{tri_ine2}
  \end{center}
  \vspace{-20pt}
  \caption{Representação gráfica da desigualdade triangular.}
\end{wrapfigure}
...
\end{itemize}
Considere a superfície terrestre com uma esfera de raio $R_{\oplus}$. Denote a longitude\index{longitude} por $\lambda$ e a latitude\index{latitude} por $\phi$. Convecione como positivas a longitude leste  e a latitude norte. Veja figura \ref{latlong}. Seja $\vct{r}=x\vct{i}+y\vct{j}+z\vct{k}$ o vetor que representa um ponto sobre a superfície da Terra. Responda:
\begin{itemize}
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=0.4\textwidth]{latlong}
  \end{center}
...
\begin{wrapfigure}{r}{0.4\textwidth}
  \begin{center}
  \vspace{-20pt}
    \includegraphics[width=0.46\textwidth]{cossenos}
  \end{center}
  %\vspace{-20pt}
  \caption{Lei dos cossenos: $\overline{BC}^2=\overline{AB}^2+\overline{AC}^2-2~\!\overline{AB}~\!\overline{AC}\cos\theta$}\label{leicossenos}
\end{wrapfigure}
...
\begin{align}
\vct{u}\cdot\vct{v}&=\vct{v}\cdot\vct{u},&\hbox{(Comutatividade)}\label{propprodesccom}\\
\vct{u}\cdot\left(\alpha\vct{v}+\beta \vct{w}\right)&=\alpha(\vct{u}\cdot\vct{v})+\beta(\vct{u}\cdot\vct{w}) ,&\hbox{(Linearidade)}\label{propprodesclin}\\
\vct{u}\cdot\vct{u}&=u^2,&\hbox{(Respeito à norma)}\label{propprodescnorma}\\
\left|\vct{u}\cdot\vct{v}\right|&\leq uv,&\hbox{(Desigualdade de Cauchy-Schwarz)}\label{propprodesccauchy}
\end{align}
\end{subequations}
...
\begin{align}
\vct{u}\times\vct{v}&=-\vct{v}\times\vct{u},&\hbox{(Anticomutatividade)}\label{propprodvecanticom}\\
\left(\alpha \vct{u}+ \beta\vct{v}\right)\times\vct{w}&=\alpha\left(\vct{u}\times\vct{w}\right)+\beta\left(\vct{v}\times\vct{w}\right),&\hbox{(Linearidade à esquerda)}\label{propprodveclin1}\\
\vct{u}\times\left(\alpha \vct{v}+ \beta\vct{w}\right)&=\alpha\left(\vct{u}\times\vct{v}\right)+\beta\left(\vct{u}\times\vct{w}\right),&\hbox{(Linearidade à direita)}\label{propprodveclin2}\\
\left(\vct{u}\times \vct{v}\right)\cdot \vct{u}&=\left(\vct{u}\times \vct{v}\right)\cdot \vct{v}=0,&\hbox{(Ortogonalidade)}\label{propprodvecorto}\\
\left\|\vct{u}\times \vct{v}\right\|&=uv\sin(\vct{u},\vct{v})
.&\hbox{(Norma)}\label{propprodvecnorma}\\
\det\left(\vct{u}; \vct{v};\vct{u}\times \vct{v}\right)&=u^2v^2\sin^2(\vct{u},\vct{v})>0
.&\hbox{(Orientação dextrogira)}\label{propprodvecorient}
\end{align}
\end{subequations}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
  \vspace{-20pt}
    \includegraphics[width=0.46\textwidth]{R_mao_dir}
  \end{center}
  %\vspace{-20pt}
...
\begin{figure}[h!]
  \begin{center}
 % \vspace{-20pt}
    \includegraphics[width=0.5\textwidth]{prod_vec_mao_dir}
  \end{center}
  %\vspace{-20pt}
...
\begin{align}
 \vec{u}\cdot\left(\vec{v}\times\vec{w}\right)&=\vec{v}\cdot\left(\vec{w}\times\vec{u}\right)=\vec{w}\cdot\left(\vec{u}\times\vec{v}\right),&\hbox{Triplo produto escalar}\\ 
 \vec{u}\times\left(\vec{v}\times\vec{w}\right)&=\left(\vec{u}\cdot\vec{w}\right)\vec{v}-\left(\vec{u}\cdot\vec{v}\right)\vec{w},&\hbox{Triplo produto vetorial} \\ 
 \left(\vec{u}\times\vec{v}\right)\times\vec{w}&=\left(\vec{u}\cdot\vec{w}\right)\vec{v}-\left(\vec{v}\cdot\vec{w}\right)\vec{u},&\hbox{Triplo produto vetorial} \\ 
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
  \vspace{-20pt}
    \includegraphics[width=0.46\textwidth]{coo_cil}
  \end{center}
  %\vspace{-20pt}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
  \vspace{-20pt}
    \includegraphics[width=0.46\textwidth]{3D_Spherical}
  \end{center}
  \caption{Representação de um ponto de coordenadas esféricas.}\label{coo_esf}
  \vspace{-20pt}
\end{wrapfigure}
